...
function initClientI18n(locale) {
    ...
    } else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$i18next$2f$dist$2f$esm$2f$i18next$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].language !== locale) {
...
;
;
function MyClient(param) {
    let { locale } = param;
    _s();
    // инициализируем i18n сразу, без useEffect
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$lib$2f$i18n$2f$init$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initClientI18n"])(locale);
...
//# sourceMappingURL=apps_client_8c56df53._.js.map