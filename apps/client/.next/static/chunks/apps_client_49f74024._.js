...
const ColorThemeSwitcher = (param)=>{
    let { open, onOpenChange, onTriggerPointerDown } = param;
    _s();
...
const LanguageSwitcher = (param)=>{
    let { locale, open, onOpenChange, onTriggerPointerDown } = param;
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
...
"[project]/apps/client/app/[locale]/hooks/useDropdownSwitcher.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useDropdownSwitcher() {
    ...
    const handleTriggerPointerDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDropdownSwitcher.useCallback[handleTriggerPointerDown]": (dropdown)=>{
            if (openDropdown && openDropdown !== dropdown) {
                // Close current, then open the next on the same click
                setOpenDropdown(null);
                requestAnimationFrame({
                    "useDropdownSwitcher.useCallback[handleTriggerPointerDown]": ()=>setOpenDropdown(dropdown)
                }["useDropdownSwitcher.useCallback[handleTriggerPointerDown]"]);
    ...
    const isOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDropdownSwitcher.useCallback[isOpen]": (dropdown)=>openDropdown === dropdown
    }["useDropdownSwitcher.useCallback[isOpen]"], [
        openDropdown
    ]);
    const toggleOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDropdownSwitcher.useCallback[toggleOpen]": (dropdown, isOpen)=>{
            setOpenDropdown(isOpen ? dropdown : null);
        }
    }["useDropdownSwitcher.useCallback[toggleOpen]"], []);
    return {
        openDropdown,
        isOpen,
        toggleOpen,
...
_s(useDropdownSwitcher, "b2Hrex3hTi2zYPQGijdxe33DUnE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$app$2f5b$locale$5d2f$hooks$2f$useDropdownSwitcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/client/app/[locale]/hooks/useDropdownSwitcher.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const ThemeAndLanguage = (param)=>{
    let { locale } = param;
    _s();
    const { isOpen, toggleOpen, handleTriggerPointerDown } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$app$2f5b$locale$5d2f$hooks$2f$useDropdownSwitcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDropdownSwitcher"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$colorThemeSwitcher$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ColorThemeSwitcher"], {
                open: isOpen(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDropdownMenuTrigger"].THEME),
                onOpenChange: (isOpen)=>toggleOpen(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDropdownMenuTrigger"].THEME, isOpen),
                onTriggerPointerDown: ()=>handleTriggerPointerDown(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDropdownMenuTrigger"].THEME)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$langSwitcher$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                locale: locale,
                open: isOpen(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDropdownMenuTrigger"].LANGUAGE),
                onOpenChange: (isOpen)=>toggleOpen(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDropdownMenuTrigger"].LANGUAGE, isOpen),
                onTriggerPointerDown: ()=>handleTriggerPointerDown(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$components$2f$shared$2f$header$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDropdownMenuTrigger"].LANGUAGE)
            }, void 0, false, {
                fileName: "[project]/apps/client/components/shared/header/themeAndLanguage.tsx",
                lineNumber: 27,
                columnNumber: 7
...
_s(ThemeAndLanguage, "Uqqq/Ost3y8yysfv60dSCk4HKT0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$app$2f5b$locale$5d2f$hooks$2f$useDropdownSwitcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDropdownSwitcher"]
    ];
});
_c = ThemeAndLanguage;
var _c;
...
//# sourceMappingURL=apps_client_49f74024._.js.map